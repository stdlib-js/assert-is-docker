...
```javascript
IS_DOCKER = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-docker@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-docker@umd/bundle.js"></script>
```
